...
public class SoundManager : MonoBehaviour
{
		...
		[SerializeField] private AudioCueSO[] loopingSounds;
		...
		private void OnLevelWasLoaded(int level)
		{
				if (level == 4)
				{
						foreach (AudioCueSO data in loopingSounds)
						{
		...
		public void PlaySFXSound(AudioCueSO audioData, Vector3 position, Transform parentTransform = null)
		{
				if (audioData != null)
				{
